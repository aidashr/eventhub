                ...
                <div className="row no-gutters">
                    <div className="col w-100 border border-secondary rounded">
                        <div className="row no-gutters bg-light p-2 align-items-center">
                            <img className="border border-secondary rounded-circle p-1 mr-2" src={this.props.event.image} width={48} height={48} alt="..." />
                            <div className="font-weight-bold">{this.props.event.user.username}</div>
                        </div>
